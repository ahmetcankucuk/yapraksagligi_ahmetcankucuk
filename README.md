...
Genel Sonuç: YOLOv8s-cls mimarisi ve PlantVillage veri seti kombinasyonu, modelin doğruluğunu anlamlı derecede yukarı taşımıştır. Eğer doğruluğu biraz daha yukarı çekmek istersen, mevcut ağırlıklarla (weights) eğitimi bir 50 epoch daha uzatabilir veya veri artırımı (data augmentation) yöntemlerine başvurabilirsin. Şu anki hali tezin için gayet tutarlı ve sunulabilir bir başarı eğrisi sunuyor.<img width="2400" height="1200" alt="results" src="https://github.com/user-attachments/assets/f2381613-9ab7-4abc-81bb-673bc89a2cf6" />
